				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Liste des sponsors <small></small>
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
									...
									<table id="example"
										...
										<thead>
											<tr class="headings" role="row">
												...
												<th class="sorting" role="columnheader" tabindex="0"
													...
													aria-controls="example" rowspan="1" colspan="1"
													aria-label="Status : activate to sort column ascending"
													style="width: 69px;">Lien</th>
													<th class="sorting" role="columnheader" tabindex="0"
													aria-controls="example" rowspan="1" colspan="1"
													aria-label="Status : activate to sort column ascending"
													style="width: 69px;">Importance</th>
										...
										<tbody role="alert" aria-live="polite" aria-relevant="all">
											<tr class="pointer odd">
												...
												<c:forEach var="sponsors" items="${listesponsors}">
													<tr>
														<td class=" ">${sponsors.nom_Partenaire}</td>
														<td>${sponsors.photo_Partenaire}</td>
														<td>${sponsors.lien_Partenaire}</td>
														<td>${sponsors.importance_Partenaire}</td>
														<td class=" last "><a
															href="sponsormodifier?id=${sponsors.id_Partenaire}"><span
																class="glyphicon glyphicon-pencil"> Modifier</span></a> <br>
															<form method="post" action="sponsor">
																<input type="hidden" id="id" name="id"
																	value="${sponsors.id_Partenaire}"> <span
																	...
																	onclick="return confirm('Voulez-vous vraiment supprimer ${sponsors.nom_Partenaire} ?')">
															</form></td>
