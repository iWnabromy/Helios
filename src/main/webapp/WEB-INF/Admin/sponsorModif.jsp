				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Modifier un Sponsor <small></small>
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
								<div id="example_wrapper" class="dataTables_wrapper" role="grid">
									...
									<div class="clear"></div>
									<form role="form" method="post" action="sponsormodifier">
										<input type="hidden" id="id" name="id"
											value="${sponsor.id_Partenaire}">
										<div class="form-group">
											<label for="email">Nom:</label> <input type="text"
												class="form-control" name="nom" id="nom"
												value="${sponsor.nom_Partenaire}">
										</div>
										<div class="form-group">
											<label>Photo:</label> <input type="text" class="form-control"
												id="photo" name="photo"
												value="${sponsor.photo_Partenaire}">
										</div>
										<div class="form-group">
											<label>Lien:</label> <input type="text" class="form-control"
												name="lien" id="lien" value="${sponsor.lien_Partenaire}">
										</div>
										<div class="form-group">
											<label>Importance:</label> <input type="number"
												class="form-control" id="importance" name="importance"
												value="${sponsor.importance_Partenaire}">
										</div>
										<div class="form-group">
											<label for="Description">Description:</label>
											<textarea name="description" id="description"
												name="description" class="form-control" rows="10" cols="250"> ${sponsor.description_Partenaire}</textarea>
										</div>
										<br> <input type="hidden" name="langue" id="langue"
											value="${sponsor.langue_Partenaire}"> <br>
