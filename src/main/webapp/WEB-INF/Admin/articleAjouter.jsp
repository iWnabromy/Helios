									...
									<form role="form" method="post" action="articleajouter">
										...
										<div class="form-group">
											<label>Catégorie :</label> <input type="text" name="categorie"
												id="categorie" class="form-control" value="">
										</div>
										<br>
