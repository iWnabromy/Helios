				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>
									Liste des categories <small></small>
								</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
									...
									<table id="example"
										...
										<tbody role="alert" aria-live="polite" aria-relevant="all">
											<tr class="pointer odd">
												...
												<c:forEach var="categories" items="${listeCategories}">
													<tr>
														<td class=" ">${categories.nom_Categorie}</td>
														<td class=" last "><a
															href="categoriemodifier?id=${categories.id_Categorie}"><span
																class="glyphicon glyphicon-pencil"> Modifier</span></a> <br>
															<form method="post" action="categorie">
																<input type="hidden" id="id" name="id"
																	value="${categories.id_Categorie}"> <span
																	...
																	onclick="return confirm('Voulez-vous vraiment supprimer ${categoriess.nom_Categorie} ?')">
															</form></td>
